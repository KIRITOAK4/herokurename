...
if BOT_TOKEN is not None:
    try:
        pbot = Client("Renamer", bot_token=BOT_TOKEN, api_id=API_ID, api_hash=API_HASH, workers=50, plugins=plugins, sleep_threshold=15)
...
if isinstance(SESSION_STRING, str) and SESSION_STRING != "None":
    try:
        ubot = Client("Chizuru", session_string=SESSION_STRING, api_id=API_ID, api_hash=API_HASH, workers=50, plugins=plugins, sleep_threshold=15)
